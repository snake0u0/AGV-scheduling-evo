...
0. **[최우선, 2026-08-13 저녁 갱신] 예산은 채웠다. 남은 것은 두 가지.**
   - **(a) validation 분할 정하기.** 지금은 train 3 / test 15뿐이라 조기 종료도 세대 선택도
     할 수 없다(하면 leakage). 17번에서 gen40이 gen65보다 held-out이 좋았는데 **고를 수
     없었다.** train/valid/test 3분할을 먼저 확정할 것.
   - **(b) 팔당 3회 반복.** 유효 65세대 1회에 약 $21, 약 2시간(중단·재개 포함).
     3회면 약 $64. 이걸 해야 "45.2%"를 방법의 성능이라고 쓸 수 있다.
   - 그 다음: AGV 4·6대, Deroussi 10개 zero-shot 전이, 교차 연산자.
