...
0. **Stage 0c (최우선)**: (a) population 상한 탐색 3000/10000 - pop1000이 아직 예산 제약
   (0.92~0.98)이라 평평해지는 지점 미확인, (b) population x 시간예산 상호작용(10초용과 600초용의
   최적 pop이 다름), (c) **규칙 순위를 튜닝된 설정에서 재측정** - 기존 규칙 결론의 유효성이 여기서
   갈림, (d) 그 다음 예산-격차 게이트 재실행 -> **LNS 판정**.
