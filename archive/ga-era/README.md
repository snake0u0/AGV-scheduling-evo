...
각 실험의 캠페인 스크립트와 결과 JSON은 여기가 아니라 `experiments/`의 번호 폴더
(`000-260724-…` ~ `006-260810-…`)에 있고, `tests/test_reported_numbers.py`가 그
수치들을 계속 지킨다. 여기 남은 것은 그 스크립트들이 쓰던 공용 모듈뿐이다.
